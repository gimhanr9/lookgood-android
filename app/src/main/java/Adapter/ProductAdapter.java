...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public ProductAdapter(List<ProductItem> products, ProductClickListener productClickListener) {
    ...
    public ProductAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ProductAdapter.ProductViewHolder(productListBinding);
    }
    ...
    public void setSearchResult(List<ProductItem> result) {
        products = result;
